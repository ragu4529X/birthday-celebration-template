    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Apoorva]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[Apoorva]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 STAY HAPPY STAY BLESSED 💖</h2>
